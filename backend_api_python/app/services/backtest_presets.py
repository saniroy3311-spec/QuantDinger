...
from app.services.backtest_execution import DEFAULT_COMMISSION, DEFAULT_SLIPPAGE

LIVE_ALIGNED_SLIPPAGE = DEFAULT_SLIPPAGE
LIVE_ALIGNED_COMMISSION = DEFAULT_COMMISSION
